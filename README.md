...
This is a slack bot designed to retrieve information about Nottingham tech events on Meetup.com
...
# About Hubot (which eventbot is built off)
eventbot is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running eventbot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

 HUBOT_SLACK_TOKEN={api key from meetup} ./bin/hubot --adapter slack

You can start eventbot locally by running:
...
Then you can interact with eventbot by typing `eventbot help`.
mands that eventbot knows about.
