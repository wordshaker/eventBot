...
module.exports = (robot) ->
 ...
 robot.respond /when is the next notts AI/i, (resp) ->
   http = require 'http'
 ...
 robot.respond /when is the next notts progs/i, (resp) ->
   http = require 'http'
 ...
 robot.respond /when is the next tech notts/i, (resp) ->
   http = require 'http'
 ...
 robot.respond /when is the next wit notts/i, (resp) ->
   http = require 'http'
 ...
 robot.respond /when is the next blockchain notts/i, (resp) ->
   http = require 'http'
 ...
 robot.respond /when is the next notts js/i, (resp) ->
   http = require 'http'
